...
class _PaymentPageWidgetState extends State<PaymentPageWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<PaymentsRecord>(
      stream: PaymentsRecord.getDocument(widget.docRef!),
      builder: (context, snapshot) {
        ...
        final paymentPagePaymentsRecord = snapshot.data!;
          ...
          child: Scaffold(
            ...
            body: SafeArea(
              ...
              child: Column(
                ...
                children: [
                  if (paymentPagePaymentsRecord.confirmed == false)
                    Expanded(
                  ...
                  if (paymentPagePaymentsRecord.confirmed == true)
                    Expanded(
                      child: Container(
                        width: MediaQuery.sizeOf(context).width * 1.0,
